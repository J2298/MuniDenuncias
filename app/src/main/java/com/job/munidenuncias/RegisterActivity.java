...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        int usuarios_id = Integer.parseInt(id);

        if (titulo.isEmpty()) {
            Toast.makeText(this, "Complete el campo titulo", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            RequestBody usuarios_idPart = RequestBody.create(MultipartBody.FORM, id);
            ...
            call = service.createDenunciaWithImage(tituloPart, usuarios_idPart, latitudPart, longitudPart, detallesPart, imagenPart);
        }
